...
Part b) illustrates the results for setting the used threads equal to 2 and c) for 4.
OpenMP here behaves as expected except for a spike using small task sizes.
The curve is raising as the overall workload increases.
There is the possibility that OpenMP might have some problems with bigger amounts of threads for this algorithm.
At least in case of small task sizes.
